...
//        Faltam N minutos para a hora de ir embora, e restam dois presentes para o elfo Buddy fabricar. Ajude-o a descobrir se ele conseguirá fabricar os dois ainda hoje, ou se deve deixar o trabalho para amanhã.
//
//        Entrada
//        Cada caso de teste inicia com um inteiro N, indicando quantos minutos faltam para o final do expediente (2 <= N <= 100).
//        Em seguida haverá dois inteiros A e B, indicando quantos minutos são necessários para fabricar os dois presentes que Buddy precisa fabricar (1 <= A, B <= 100).
//
//        Saída
